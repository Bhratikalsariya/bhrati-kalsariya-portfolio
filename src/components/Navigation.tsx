...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-900/90 dark:bg-gray-900/90 backdrop-blur-md border-b border-gray-200/20 dark:border-gray-700/30">
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white dark:bg-gray-900 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
